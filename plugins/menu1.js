...
await conn.fakeReply(m.chat, '*[❗] Ｌｏｄｉｎｇ．．．*', '0@s.whatsapp.net', '©create by DinarXT', 'status@broadcast')
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: '©create by DinarXT', //Kasih namalu
                            orderTitle: 'Gorengan',
...
const freply = {key:{ fromMe:false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: {
	...
	"productImageCount": 1
						...
						"businessOwnerJid": "6281333389713@s.whatsapp.net"}}}    
...
『${petik}Im ${conn.getName(conn.user.jid)} Gunakan Prefix %p${petik}』
...
╭─「Gc Bot」
 ...
 |❏ ${petik} https://chat.whatsapp.com/IGMByO1wnFIEHplRGPHcJr ${petik} 
╰────↩
╭─「Ｉｎｆｏ Ｕｓｅｒ」
