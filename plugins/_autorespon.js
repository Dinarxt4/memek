    ...
    try {
        if (m.mentionedJid.includes(this.user.jid) && m.isGroup) {
            await this.send2Button(m.chat,
                isBanned ? 'Bot Wea NEXT PROJECT NOT ACTIVE' : banned ? 'TELAH DI BANNED' : 'Bot Wea NEXT PROJECT IN HERE',
                '©Bot Wea',
...
`.trim(), '©Bot Wea', 'CHAT ME TO BUY', ',owner', { contextInfo: { mentionedJid: [global.owner[0] + '@s.whatsapp.net'] } })
    }
